...
<ManualSection id="daily">
	...
	<p>
		<strong>開くことと点が入ることは別です。</strong>点が足されるのは、その日の基本点（{SCREEN.sectionHabits}＋{SCREEN.sectionDaily}）が100点になった日だけ。「{SCREEN.sectionHabits}」に「やらなかった」や未記入が残ったまま1日が終わると、チャレンジの記録は残っても点にはなりません。開いていて点がまだ入らないあいだは、画面に「{SCREEN.challengeBonusPending}」と出ます。
	</p>
	<p>
